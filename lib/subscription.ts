...
export async function purchaseSubscription(
  ...
  if (currentSubscription) {
    const currentTier = PLAN_HIERARCHY[currentSubscription.plan as SubscriptionPlanId];
    ...
    if (newTier < currentTier) {
      return {
        success: false,
        error: 'Daha düşük bir pakete geçiş yapamazsınız. Mevcut paketiniz sona erene kadar bekleyebilir veya destek ile iletişime geçebilirsiniz.'
      };
    }
  ...
  const creditsResetDate = planId === 'free'
