        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {Object.entries(SUBSCRIPTION_PLANS).map(([id, plan]) => {
            ...
            const currentTier = subscription
              ? PLAN_HIERARCHY[subscription.plan]
              : -1;
        ...
        <div className="mt-16 text-center">
          <div className="glass-card p-8 max-w-3xl mx-auto">
            ...
            <p className="text-neutral-600 dark:text-neutral-400 mb-4">
              Tüm paketler otomatik olarak yenilenir. İstediğiniz zaman iptal
              edebilirsiniz. Ücretsiz paketten premium pakete geçiş anında
              etkinleşir.
            </p>
            <p className="text-sm text-neutral-500 dark:text-neutral-500">
              Sorularınız için:{" "}
              <a
                href="mailto:destek@masalkutusu.com"
                className="text-primary-500 hover:underline"
              >
                destek@masalkutusu.com
              </a>
            </p>
          </div>
        </div>
